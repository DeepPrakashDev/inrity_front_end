                    ...
                    <div className="grid lg:grid-flow-col md:grid-flow-row grid-cols-12 gap-5">
                        <div className="lg:col-span-6 md:col-span-6 col-span-12 p-4 border border-[#e0e2e7] rounded-lg">
                            <div className="heading pb-[30px] flex flex-wrap justify-between">
                                <div className="">
                                    <h4 className="text-[20px] font-semibold">Sector Subscription Summary</h4>
                                    <p className="text-[#1a9882] text-[12px] font-semibold ml-2">10% <FontAwesomeIcon icon={faCaretUp} className="w-2 ml-1 text-[#1a9882]" /> <span className="text-[#858D9D] ml-1">+2 today</span></p>
                                </div>
                                <div className="mb-2">
                                    <Link href='javascript:void(0)' className='subscription-btn bg-[#b3bfff] text-[13px] px-3 py-2 mx-2 rounded-sm'>Add Sectors</Link>
                                </div>
                            </div>
                        ...
                        <div className="lg:col-span-6 md:col-span-6 col-span-12 p-4 border border-[#e0e2e7] rounded-lg">
                            <div className="heading pb-[30px] flex flex-wrap justify-between">
                                <div className="">
                                    <h4 className="text-[20px] font-semibold">Reports Subscribed</h4>
                                    <p className="text-[#1a9882] text-[12px] font-semibold ml-2">10% <FontAwesomeIcon icon={faCaretUp} className="w-2 ml-1 text-[#1a9882]" /> <span className="text-[#858D9D] ml-1">+2 today</span></p>
                                </div>
                                <div className="mb-2">
                                    <Link href='javascript:void(0)' className='subscription-btn bg-[#b3bfff] text-[13px] px-3 py-2 mx-2 rounded-sm'>Add Sectors</Link>
                            ...
                            <ul className="chart-months flex items-center bg-[#dee3ff] p-1 mt-5">
                                ...
                                <li className="active grow-1 bg-[#000088] text-white text-[11px] text-center rounded-lg">Jun</li>
            ...
            <section className="subscription-main mt-[50px] xl:p-0 lg:p-4 md:p-4 p-4">
                <div className="container mx-auto">
                    ...
                    <div className="grid lg:grid-flow-col md:grid-flow-row grid-cols-12 gap-5">
                        <div className="lg:col-span-6 md:col-span-6 col-span-12 p-4 border border-[#e0e2e7] rounded-lg">
                            <div className="">
                                <h4 className="subtitle text-[#777980] mb-2">Industries Subscribed</h4>
