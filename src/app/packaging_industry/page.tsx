...
const page = () => {
    ...
    return (
        <>
            ...
            {/* -------------Packaging Industry--------------- */}
            <section className="packaging-industry-cover mt-[40]">
                <div className="container mx-auto">
                    <div className="bg-[url('/assets/images/package-cover.png')] bg-cover bg-center h-30 w-full relative">
                        <div className="absolute inset-0 bg-black opacity-50 z-1"></div>
                        <div className="relative z-9999 content-center text-center h-full text-white p-4">
                            <h4 className="text-[20px]">Packaging Industry</h4>
                            <p className="text-[13px]">Your Industry</p>
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section className="trending-now mt-[50px]">
                <div className="container mx-auto">
                    <div className="content-wrap p-[30px] pb-[50px]">
                        ...
                        <div className="grid md:grid-cols-12 lg:grid-cols-5 md:grid-flow-row grid-flow-row gap-4">
                            <div className="trending-now-card lg:col-span-1 md:col-span-4 col-span-1 p-5 border-l-4 border-l-[#dde0f1]">
            ...
            <section className="top-products rounded-sm mt-[50px]">
                <div className="container mx-auto">
                    <div className="sec-bg bg-gradient-to-r from-[var(--primary-color)] to-[#7F00E3] w-full h-full px-5 py-[25px] rounded-sm">
                        <div className="grid grid-cols-1 md:grid-cols-12 lg:grid-cols-12 md:grid-flow-row grid-flow-row gap-4">
                            <div className="col-span-12">
                                <div className="heading mb-5">
                                    <h3 className="text-[20px] text-white font-semibold">Our Top Products</h3>
                                    <p className="text-[13px] text-white">Explore our latest products</p>
                                </div>
                            </div>
                            <div className="lg:col-span-4 md:col-span-6 col-span-12 mb-5">
                                <div className="flex items-center xl:pr-[50px]">
                                    <Image src="/assets/images/compass.jpg" height={130} width={130} className="m-w-full rounded-lg mb-2" alt="client" />
                                    <div className="content-wrap text-white p-2">
                                        <h4 className="">MI 360</h4>
                                        <p className="text-[13px] mb-3">Procurement Intelligence</p>
                                        <p className="text-[13px]">About the Product small description. Ullamcorper nec magna arcu feugiat vitae pellentesque et pharetra neque.</p>
                                    </div>
                                </div>
                            </div>
                            <div className="lg:col-span-4 md:col-span-6 col-span-12 mb-5">
                                <div className="flex items-center xl:pr-[50px]">
                                    <Image src="/assets/images/compass.jpg" height={130} width={130} className="m-w-full rounded-lg mb-2" alt="client" />
                                    <div className="content-wrap text-white p-2">
                                        <h4 className="">Sourcing Compass</h4>
                                        <p className="text-[13px] mb-3">Procurement Intelligence</p>
                                        <p className="text-[13px]">About the Product small description. Ullamcorper nec magna arcu feugiat vitae pellentesque et pharetra neque.</p>
                                    </div>
                                </div>
            ...
            <section className="my-activity-sec mt-[50px] mb-[50px]">
                <div className="container mx-auto">
                    <div className="grid lg:grid-flow-col md:grid-flow-row grid-cols-12 gap-4">
                        <div className="lg:col-span-8 col-span-12 bg-white border border-[#e0e2e7] rounded-lg p-4">
                            <div className="heading mb-3">
                        ...
                        <div className="lg:col-span-4 col-span-12 bg-white border border-[#e0e2e7] rounded-lg">
